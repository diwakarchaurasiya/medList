  ...
  return (
    ...
    <div className='flex gap-20 my-10 flex-wrap text-sm justify-between'>
      ...
      <div className="logo mb-4">
          <Link to='/' onClick={()=>scrollTo(0,0)} className='  flex items-center' ><img src={assets.logo} alt="logo" className='w-16' /><span className='text-4xl font-bold text-primary'>MedList</span></Link>
        </div>
        <p className='w-full  leading-6 text-[gray]  '>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.</p>
      </div>
      <div className="col-2">
        ...
        <ul className='  text-[gray] text-md'>
          <li className='mb-2'>
            ...
            <li className='mb-2'><Link to='/address'>Address</Link></li>
          
        </ul>
</div>
      <div className="col-2  text-[gray] ">
        <h2 className='text-xl font-medium mb-4 text-black'>GET IN TOUCH</h2>
        <span className='py-8'><a href="tel:+918127376896">+918127376896</a></span>
        <br />
      ...
      <div className="copyRight text-center my-6">
